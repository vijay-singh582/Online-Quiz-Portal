<%@ Page Title="" Language="C#" MasterPageFile="~/Page11.master" AutoEventWireup="true" CodeFile="Page12.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        ...
        <asp:Label ID="Label5" runat="server" Font-Size="XX-Large" 
            ForeColor="DarkTurquoise" Text="Dashboard"></asp:Label>
        &nbsp;</p>
 ...
 1.) Many Quizs are available for each Course.<br/>
  ...
  6.) Result showed after the submit of quiz.<br/></marquee></p>
   </th>
   <td style="color: #FF6600; font-size: x-large; height:200px; width:200px; border-top: thick solid #808080; border-bottom: thick solid #808080; border-top-color: #FF6600; border-bottom-color: #00FF00;" 
          class="style2">  
       
      Calendar <asp:Calendar ID="Calendar1" runat="server" Height="180px" 
