...
public partial class Page11 : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["c"] != null)
        {
            SqlDataAdapter da = new SqlDataAdapter("Select * from  Student where Student_ID='" + Session["c"] + "'", @"Data Source=hp\SQLEXPRESS;Initial Catalog=Quiz;Integrated Security=True");
