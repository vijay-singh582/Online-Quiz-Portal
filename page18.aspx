<%@ Page Title="" Language="C#" MasterPageFile="~/page17.master" AutoEventWireup="true" CodeFile="page18.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  6.) Result showed after the submit of quiz.<br/></marquee>
   ...
   <td style="color: #FF6600; font-size: x-large; height:200px; width:200px; border-top: thick solid #808080; border-bottom: thick solid #808080; border-top-color: #FF6600; border-bottom-color: #00FF00;" 
          class="style2">  
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         Calendar<asp:Calendar ID="Calendar1" runat="server" ForeColor="Black" 
             Height="180px"  Width="200px"
          BackColor="White" FirstDayOfWeek="Monday" Font-Size="Small" 
